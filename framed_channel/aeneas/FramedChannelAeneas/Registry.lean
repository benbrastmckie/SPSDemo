...
/-- One hundred rows across both packages. -/
example : allBank.length = 100 := by decide

-- At one hundred rows, deciding the witness strings needs more than the default recursion depth.
